...
const cvsFiltration = (arr) => {
  // write your code here
  var filtered = arr
    .filter((cv) => cv.yearsOfExperience > 4 && cv.tech === "JS")
    .map((cv) => {
...
const skillComparison = (arr1, arr2) => {
    // write your code here
    let result=[];
     arr1.filter(skill => !arr2.includes(skill)).forEach(skill => result.push(skill));
     arr2.filter(skill => !arr1.includes(skill)).forEach(skill => result.push(skill));
     return result
  };
// -------------------------------------------------------------------------------------------------------
